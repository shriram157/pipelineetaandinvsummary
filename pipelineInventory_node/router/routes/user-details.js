					...
					bpResults = bpResults.filter(o => {
						...
						for (var i = 0; i < customerSalesArea.results.length; i++) {
							if ((customerSalesArea.results[i].SalesOffice === "1000" || customerSalesArea.results[i].SalesOffice === "2000" ||
									...
									customerSalesArea.results[i].SalesOffice === "9000" || customerSalesArea.results[i].SalesOffice === "8000" || (customerSalesArea.results[i].SalesGroup == "T99" && customerSalesArea.results[i].ProductAttribute1 == "X")) && ((
