...
sap.ui.define([
	...
	return BaseController.extend("toyota.ca.xsaapp.PipelineETAInventSummary.controller.details", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf toyota.ca.xsaapp.PipelineETAInventSummary.view.details
		 */
		onInit: function () {
			_that = this;
		...
		onNavigateToVL: function(oNavEvent) {
			this.getRouter().navTo("vehicleDetails", {
				OrderNumber : oNavEvent.getSource().getModel("DummyJSONModel").getProperty(oNavEvent.getSource().getBindingContext("DummyJSONModel").sPath).ProductId
			});
		},
