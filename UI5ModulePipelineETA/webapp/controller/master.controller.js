...
sap.ui.define([
	...
	return BaseController.extend("toyota.ca.xsaapp.PipelineETAInventSummary.controller.master", {
		...
		onInit: function () {
			...
			var oModel = new sap.ui.model.odata.v2.ODataModel("https://sapdev.apimanagement.ca1.hana.ondemand.com:443/API_BUSINESS_PARTNER/");
			oModel.setUseBatch(true);
			var oData1;
			oModel.read("/API_BUSINESS_PARTNER", true);
			oModel.attachRequestCompleted(function (oEvent) {
				oData1 = oEvent.getSource().oData;
				console.log(oData1);
			});
			...
			// _that.oGlobalJSONModel.setData(_ObjModelYear);
			...
			//_that.oDataService = "https://tcid1gwapp1.tci.internal.toyota.ca:44300/sap/opu/odata/sap/Z_VEHICLE_MASTER_SRV/";
			// _that.oDataService = "https://tcid1gwapp1.tci.internal.toyota.ca:44300/sap/opu/odata/sap/Z_VEHICLE_MASTER_SRV/";
			_that.oDataServiceModel = new sap.ui.model.odata.ODataModel(_that.oDataService);
			_that.oDataServiceModel.read("zc_mmfields", null, null, true,
				function (oData) {
			...
			_that.oDataServiceModel.read("zc_model", null, null, true,
				function (oData) {
				...
				function (oError) {});
			_that.oDataServiceModel.read("zc_exterior_trim", null, null, true,
				function (oData) {
			...
			$.ajax({
				dataType: "json",
				url: _that.oDataService+"/API_BUSINESS_PARTNER/",
				type: "GET",
				success: function (oData) {
					// debugger;
					var dealerObj = {
